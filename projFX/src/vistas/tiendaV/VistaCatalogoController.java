...
public class VistaCatalogoController implements Initializable {
    ...
    public void aggItem(List<Producto> agregados){
        
        Catalogo = FXCollections.observableArrayList(agregados);
        itemstbl.setItems(Catalogo);}
    /*ListaProductos lista = DatosEnlazados.listaProductos;
    ListaProductos refresh = (ObservableList) DatosEnlazados.listaProductos;
    
    lista.eliminarLibro(DatosEnlazados.vendedorAct.getCodigo());
